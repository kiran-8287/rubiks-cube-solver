...
import solutionGuide from '../../images/rubiks-cube-calculator-solution.png';
  ...
  return (
    <div className="solution-walkthrough">
      ...
      <div className="solution-visual">
        <img
          src={solutionGuide}
          alt="Solution walkthrough reference showing Rubik's Cube move order"
          loading="lazy"
        />
        <p className="visual-caption">
          Visual reference for the calculated solution — follow along with the move list.
        </p>
      </div>
    </div>
  );
